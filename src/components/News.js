...
export class News extends Component {
    ...
    async updateNews() {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=082dac09049f407ca2c42e4f44996bf2&page=${this.state.page}&pageSize=${this.props.pageSize}`
        this.setState({
            loading: true
        })
